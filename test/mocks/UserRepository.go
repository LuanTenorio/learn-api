...
func (_m *UserRepository) CreateUser(ctx context.Context, userDto *dto.CreateUserDTO) (*entity.User, error) {
...
func (_m *UserRepository) FindUserAndPwdByEmail(ctx context.Context, email string) (*dto.UserWithPwdDTO, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*dto.UserWithPwdDTO, error)); ok {
		return rf(ctx, email)
	}
